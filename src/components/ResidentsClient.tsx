    ...
    return (
      <Card className="shadow-md">
        <CardHeader className="pb-3">
          <CardTitle className="text-2xl font-bold text-green-primary">Resident Profiles</CardTitle>
          <CardDescription>You are not registered as a resident yet</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center justify-center py-10 text-center">
          <User2 className="h-16 w-16 text-muted-foreground mb-4" />
          <h3 className="text-xl font-semibold mb-2">No Resident Profiles Found</h3>
          <p className="text-muted-foreground max-w-md mb-6">
            Your account is not linked to any resident profile in Barangay Bahay Toro. 
            You can create a resident profile to request certificates and access more services.
          </p>
          <Dialog>
            <DialogTrigger asChild>
              <Button className="gap-2">
                <HelpCircle className="h-4 w-4" />
                How to Add a Resident Profile
              </Button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Creating a Resident Profile</DialogTitle>
                <DialogDescription>
                  To create a resident profile, you need to request a certificate from the Services page.
                </DialogDescription>
              </DialogHeader>
              <div className="py-4">
                <p className="mb-3">A resident profile will be automatically created when you request your first certificate. This ensures that:</p>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                  <li>Your information is properly verified</li>
                  <li>All your certificates are linked to a verified resident profile</li>
                  <li>You only need to enter your personal information once</li>
                </ul>
    ...
    <Card className="shadow-md">
      <CardHeader className="px-7 flex flex-row items-center justify-between border-b pb-4">
        <div>
          ...
          <CardDescription>Manage your registered resident profiles</CardDescription>
        </div>
        <Dialog>
          <DialogTrigger asChild>
      ...
      <CardFooter className="border-t p-4 flex justify-between text-sm text-muted-foreground">
        <div>Total residents: {userResidents.length}</div>
      </CardFooter>
    </Card>
  );
}